...
drop database if exists imarticus_learning;
...
describe Employee;       # To check the description of the table use describe command
...
alter table students_Details change AGE Date_of_Birth date;      # Renaming DOB column to Date of Birth
alter table students_Details rename Students_info;     # Renaming Table Name
select * from students_info;

/* DML [Data Manipulation Language]
Data Manipulation Language used to Manipulate the data present in the Database
...
select * from students_info;
insert into students_info values('Jeevan','Raj','1997-12-31','M',9141919300,'Bangalore','MySQL');    # Note always you want to insert the date in YYYY-MM-DD format
insert into students_info values('Navya','Shree','1995-09-09','F',8073529011,'Bangalore','Python'),
...
Select * from students_info where program='MySQL';          # Will write a query to extract MySQL Program
...
commit;
insert into students_info values('Jeevan','Raj','1998-12-30','M',9141919311,'Bangalore','Python');
delete from students_info where first_name='Jeevan';
